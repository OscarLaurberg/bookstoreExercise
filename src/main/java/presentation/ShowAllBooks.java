...
public class ShowAllBooks extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String bookHtmlTable = CollectionToHtml.bookListToHtmlTable(books);
        String bookHtmlForm = CollectionToHtml.bookListToHtmlForm(books);
        try ( PrintWriter out = response.getWriter()) {
            /* TODO output your page here. You may use following sample code. */
            out.println("<!DOCTYPE html>");
            out.println("<html>");
            out.println("<head>");
            out.println("<title>All Books search result</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1 style=\"color:blue;\">Search results:</h1>");
